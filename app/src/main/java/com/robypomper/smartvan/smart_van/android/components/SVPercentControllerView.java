...
import com.robypomper.josp.jsl.android.components.JSLRangeStateView;
 ...
 * <p>
 * View's default layout {@link R.layout#def_view_sv_percent_controller}
 */
public class SVPercentControllerView
        extends JSLRangeStateView
        implements SVBaseControllerServiceView {

    // Constants

    private final static int LAYOUT = R.layout.def_view_sv_percent_controller;
    ...
    public SVPercentControllerView(@NonNull Context context) {
        this(context, null);
    }

    public SVPercentControllerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SVPercentControllerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, null, LAYOUT);
    }

    public SVPercentControllerView(@NonNull Context context, JSLRangeState svService, @LayoutRes int layout) {
        this(context, null, svService, layout);
    }

    public SVPercentControllerView(@NonNull Context context, @Nullable AttributeSet attrs, JSLRangeState svService, @LayoutRes int layout) {
        this(context, attrs, 0, svService, layout);
    }

    public SVPercentControllerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, JSLRangeState svService, @LayoutRes int layout) {
